    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_dial_number:
                String number = "082131609462";
                Intent moveDial = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:"+number));
...
//            int value = data.getIntExtra(MoveForResultActivity.EXTRA_SELECTED_VALUE, 0);
//            tvResult.setText(String.format("Nama Anda = %s", value));
        }
    }
}
